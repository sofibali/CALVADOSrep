...
parser.add_argument('--name_3',nargs='?',required=True,type=str)
args = parser.parse_args()

cwd = os.getcwd()
sysname = f'{args.name_1:s}_{args.name_2:s}_{args.name_3:s}'
...
components.add(name=args.name_1, restraint='harmonic', use_com=True)
components.add(name=args.name_2, restraint='harmonic', use_com=True)
components.add(name=args.name_3, restraint='harmonic', use_com=True)
components.add(name='chain_D', molecule_type='ion', nmol=0, restraint=False)
components.add(name='chain_E', molecule_type='rna', nmol=1, restraint=True)
components.add(name='chain_F', molecule_type='rna', nmol=1, restraint=True)

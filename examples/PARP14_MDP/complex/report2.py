...
ax.set_xlabel('fraction of the 100 ns spent in contact (min CA-CA < 1 nm)')
ax.set_title('Every CALVADOS complex dissociates. Dashed line = the 50% bar for a usable contact map',
             loc='left',fontsize=8)

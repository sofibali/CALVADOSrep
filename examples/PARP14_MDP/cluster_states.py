...
def extract_features_one_replicate(args):
    ...
    if features_mode == 'ca':
        ...
        ref_pdb = sim_dir.parent / 'seed-1_sample-0' / 'top.pdb'
...
def main():
    ...
    run_tag = f'{set_key.replace("frag_","")}_{feat_tag}_{args.reduce}'
    import sys as _sys

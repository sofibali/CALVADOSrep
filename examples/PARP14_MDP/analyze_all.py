...
def _plot_conf_prop(active_sets, all_data):
    ...
    plt.close()
    print(f"  Saved: figures/rg_timeseries, conf_prop_distributions, rg_convergence")
...
def run_active_site_analysis(active_sets):
    ...
    plt.close()
    print(f"  Saved: figures/active_site_rmsf, active_site_radial, intersite_distances, active_site_summary")
